...
@section('content')
    ...
    <div class="app-content mt-0 pt-1">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="table-add float-right">
                                    <a href="{{ route('admin.blogs.create') }}" class="btn btn-icon">
                                        <i class="fa fa-plus fa-1x" aria-hidden="true"></i>
                                    </a>
                                </span>
                                <h4 id="totallll">
                                    {{ trans('translations.blogs_list') }}
                                </h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group dropdown">
                                                            <button type="button"
                                                                class="btn btn-sm btn-info m-b-5 m-t-5"
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <button type="button" style="cursor: pointer" class="dropdown-item has-icon"
                                                                    data-toggle="modal"
                                                                    data-target="#delete_model_{{ $blog->id }}">
        ...
        @foreach ($list as $blog)
            <!-- Message Modal -->
            <div class="modal fade" id="delete_model_{{ $blog->id }}" tabindex="-1" role="dialog"
                aria-hidden="true">
