    ...
    <div class="app-content mt-0 pt-1">
        <section class="section">
            <div class="row">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" type="get" action="{{ route("admin.branches.index") }}" autocomplete="off">
                                ...
                                <button type="submit" class="btn btn-primary mt-1 mb-0">{{ trans("translations.search") }}</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/" class="text-light-color">{{trans('translations.home')}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{trans('translations.branches')}}</li>
                </ol>
            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="table-add float-right">
                                    <a href="{{ route('admin.branches.create') }}" class="btn btn-icon">
                                        <i class="fa fa-plus fa-1x" aria-hidden="true"></i>
                                    </a>
                                </span>
                                <h4 id="totallll">
                                    {{trans('translations.branches_list')}}
                                </h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover mb-0 text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{trans('translations.phone_one')}}</th>
                                                <th>{{trans('translations.phone_two')}}</th>
                                                <th>{{trans('translations.address')}}</th>
                                                        ...
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('admin.branches.edit', ['branch' => $branch->id]) }}">
                                                                    <i class="fa fa-edit"></i>{{trans("translations.edit")}}
                                                                </a>

                                                                <button type="button" class="dropdown-item has-icon"
                                                                        data-toggle="modal"
                                                                        data-target="#delete_model_{{ $branch->id }}">
                                                                    <i class="fa fa-trash"></i> {{trans("translations.remove")}}
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </td>
            ...
            <div class="modal fade" id="delete_model_{{ $branch->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.branches.destroy', ['branch' => $branch->id]) }}" method="Post">
                            @method('DELETE')
                            @csrf
